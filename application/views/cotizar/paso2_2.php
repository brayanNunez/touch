                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col s12 m12 l12 celdaBoton">
                                    ...
                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text" href="#!" data-activates="dropdown-cotizacion1-item1">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col s12 m12 l12 celdaBoton">
                                    ...
                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text" href="#!" data-activates="dropdown-cotizacion1-item2">
                                        <?=label('menuOpciones_seleccionar')?><i class="mdi-navigation-arrow-drop-down"></i>
                                    </a>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col s12 m12 l12 celdaBoton">
                                    ...
                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text" href="#!" data-activates="dropdown-cotizacion1-item3">
                                        <?=label('menuOpciones_seleccionar')?><i class="mdi-navigation-arrow-drop-down"></i>
                                    </a>
                                </div>
                            </td>
