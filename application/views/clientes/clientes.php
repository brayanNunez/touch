                                ...
                                <form class="col s12">
                                    <div class="row">
                                        ...
                                        <div class="inputTag col s12">
                                            <label
                                                for="vendedoresCliente"><?= label('formCliente_cotizador'); ?></label>
                                            <br>

                                            <div id="vendedoresCliente" class="example example_objects_as_tags">
                                                <div class="bs-example">
                                                    <input placeholder="<?= label('formCliente_anadirVendedor'); ?>"
                                                           type="text"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="input-field col s12">
                                                ...
                                                <table id="cliente1-contactos" class="table striped">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            <input type="checkbox" class="filled-in checkbox"
                                                                   id="checkbox_cliente1_contacto1"/>
                                                            <label for="checkbox_cliente1_contacto1"></label>
                                                        </td>
                                                        <td>Maria Rodriguez</td>
                                                        <td>maria@gmail.com</td>
                                                        <td>
                                                            <ul id="dropdown-cliente1-contacto1"
                                                            ...
                                                            <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                               href="#!" data-activates="dropdown-cliente1-contacto1">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            <input type="checkbox" class="filled-in checkbox"
                                                                   id="checkbox_cliente1_contacto2"/>
                                                            <label for="checkbox_cliente1_contacto2"></label>
                                                        </td>
                                                        <td>Juan Perez</td>
                                                        <td>juan@gmail.com</td>
                                                        <td>
                                                            <ul id="dropdown-cliente1-contacto2"
                                                                class="dropdown-content">
                                                                <li>
                                                                    <a href="#editarContacto"
                                                                       class="-text modal-trigger"><?= label('menuOpciones_editar') ?></a>
                                                            ...
                                                            <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                               href="#!" data-activates="dropdown-cliente1-contacto2">
                                                                <?= label('menuOpciones_seleccionar') ?><i
                                                                    class="mdi-navigation-arrow-drop-down"></i>
                                                            </a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            <input type="checkbox" class="filled-in checkbox"
                                                                   id="checkbox_cliente1_contacto3"/>
                                                            <label for="checkbox_cliente1_contacto3"></label>
                                                        </td>
                                                        <td>Jose Mora</td>
                                                        <td>jose@gmail.com</td>
                                                        <td>
                                                            <ul id="dropdown-cliente1-contacto3"
                                                                class="dropdown-content">
                                                                <li>
                                                                    <a href="#editarContacto"
                                                                       class="-text modal-trigger"><?= label('menuOpciones_editar') ?></a>
                                                            ...
                                                            <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                               href="#!" data-activates="dropdown-cliente1-contacto3">
                                                                <?= label('menuOpciones_seleccionar') ?><i
                                                                    class="mdi-navigation-arrow-drop-down"></i>
                                                            </a>
                                                        </td>
                                                ...
                                                <div>
                                                    <a href="#agregar"
                                                       class="btn btn-default modal-trigger"><?= label('formCliente_agregar'); ?></a>
                                            ...
                                            <div class="input-field col s12">
                                                ...
                                                <div class="input-field col s12">
                                                    <div class="input-field col s8">
                                                        ...
                                                        <label
                                                            for="cliente_nuevoGusto"><?= label('formCliente_nuevoGusto'); ?></label>
                                                    </div>
                                                    <div class="input-field col s4">
                                                        <a href="#"
                                                           class="btn btn-default"><?= label('formCliente_agregarNuevo'); ?></a>
                                                    </div>
                                                </div>
                                                <hr/>
                                            </div>
                                            <div class="input-field col s12">
                                                ...
                                                <div class="input-field col s12">
                                                    <div class="input-field col s8">
                                                        ...
                                                        <label
                                                            for="cliente_nuevoMedio"><?= label('formCliente_nuevoMedio'); ?></label>
                                                    </div>
                                                    <div class="input-field col s4">
                                                        <a href="#"
                                                           class="btn btn-default"><?= label('formCliente_agregarNuevo'); ?></a>
