    ...
    <form id="form_cliente" class="col s12" action="<?= base_url() ?>clientes/modificar/<?php if (isset($resultado)) echo encryptIt($resultado['idCliente']);?>" method="POST">
        <div class="row">
            ...
            <div class="col s12">
                <div id="tab-direccion-editar" class="card col s12">
                    <div>
                        ...
                        <div class="input-field col s12 m12 l12">
                            <textarea length="200" maxlength="200" id="cliente_direccionDomicilio" name="cliente_direccionDomicilio" class="materialize-textarea" rows="4"><?php if (isset($resultado)) echo $resultado['domicilio'];?></textarea>
                ...
                <div id="tab-infoFacturacion-editar" class="card col s12" style="padding-bottom: 20px;">
                    <div class="input-field col s12 inputSelector" >
            ...
            <div class="input-field col s12 envio-formulario" style="padding-bottom: 20px;">
...
<script>
    ...
    if(isset($resultado)) {
        ...
        $pais = $resultado['pais'];
        $formaPago = $resultado['idFormaPagoDefecto'];
        $moneda = $resultado['idMonedaDefecto'];
    }
    ?>
        $('#cliente_nacionalidad').val('<?= $nacionalidad; ?>').change();
        $('#cliente_direccionPais').val('<?= $pais; ?>').change();
        $('#cliente_formaPago').val('<?= $formaPago; ?>').change();
        $('#cliente_monedaCotizar').val('<?= $moneda; ?>').change();
        var tipo = '<?= $juridico; ?>';
        if(tipo == 1) {
            $('#cliente_tipo').val(1).change();
        } else {
