    ...
    <div class="container"
        ...
        <div class="row home">
            ...
            <div class="col-md-3 col-sm-3 mb-xs-24">
                ...
                <ul>
                    <li><a class="footer-link"
                           href="<?= base_url() ?>welcome/index/#planes"><?= label('cuantoDeboPagar'); ?></a></li>
                    <li><a class="footer-link"
                           href="<?= base_url() ?>welcome/index/#planes"><?= label('tiposDePlanes'); ?></a></li>
                    <li><a class="footer-link"
    ...
    <div class="col s12 z-depth-4 card-panel" style="box-shadow: none; margin: 0px; padding-bottom: 0px; ">
        <form class="login-form" style="width: auto; ">
            ...
            <div class="row" style="margin-bottom: 0;">
                <div class="input-field col s12">
                    <a href=""
                       class="btn btn-logueo waves-effect waves-light col s12"><?= label('olvidarContrasenna_enviar') ?></a>
                </div>
            </div>
        </form>
    </div>
