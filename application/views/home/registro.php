                                ...
                                <form class="col s12">
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <!--                                            <label for="registro_nombreEmpresa" class="active">-->
                                            <? //=label('formRegistro_nombre');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="registro_nombre" class="campo-registro" type="text"
                                                   placeholder="Escriba su nombre completo">
                                            <!--                                            <label for="registro_nombre" class="active">-->
                                            <? //=label('formRegistro_nombre');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="registro_correo" class="campo-registro" type="email"
                                                   placeholder="Escriba su correo electrónico">
                                            <!--                                            <label for="registro_correo" class="active">-->
                                            <? //=label('formRegistro_correo');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="registro_telefono" class="campo-registro" type="text"
                                                   placeholder="Escriba su número de teléfono">
                                            <!--                                            <label for="registro_telefono" class="active">-->
                                            <? //=label('formRegistro_telefono');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="registro_sitioWeb" class="campo-registro" type="text"
                                                   placeholder="Escriba su sitio web">
                                            <!--                                            <label for="registro_sitioWeb" class="active">-->
                                            <? //=label('formRegistro_sitioWeb');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="registro_nombreUsuario" class="campo-registro" type="text"
                                                   placeholder="Escriba su nombre de usuario">
                                            <!--                                            <label for="registro_nombreUsuario" class="active">-->
                                            <? //=label('formRegistro_nombreUsuario');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="registro_contrasena" class="campo-registro" type="password"
                                                   placeholder="Escriba su contraseña">
                                            <!--                                            <label for="registro_contrasena" class="active">-->
                                            <? //=label('formRegistro_contrasena');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="registro_contrasenaConfirm" class="campo-registro"
                                                   type="password"
                                                   placeholder="Confirme su contraseña">
                                            <!--                                            <label for="registro_contrasenaConfirm" class="active">-->
                                            <? //=label('formRegistro_contrasenaConfirm');?><!--</label>-->
                                        </div>
                                        <div class="input-field col s12 country-select">
                                            <select>
                                                <option class="selected-option" selected disabled>Seleccione el país al
                                                    que pertenece
                                                </option>
                                            ...
                                            <!--                                            <label for="registro_country" class="active">-->
                                            <? //=label('formRegistro_contrasenaConfirm');?><!--</label>-->
                                        </div>
                                        <div class="file-field col s12">
                                            <br/>
                                            <!--                                            <label for="registro_fotografia">-->
                                            <? //=label('formRegistro_fotografia');?><!--</label>-->
