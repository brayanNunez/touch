            ...
            <div class="container">
                ...
                <div class="row home">
                    <div class="col-md-3 col-sm-6 mb-xs-24">
                        ...
                        <ul>
                            <li><a href="<?=base_url()?>welcome/que"><?=label('queEsTouch');?></a></li>
                            <li><a href="<?=base_url()?>welcome/como"><?=label('comoFunciona');?></a></li>
                            <li><a href="<?=base_url()?>welcome/quienes"><?=label('quienesLoUsan');?></a></li>
                            <li><a href="<?=base_url()?>welcome/beneficios"><?=label('beneficios');?></a></li>
                            <li><a href="<?=base_url()?>welcome/precios"><?=label('precios');?></a></li>
                            <li><a href="<?=base_url()?>welcome/faq"><?=label('faq');?></a></li>
                            <li><a href="<?=base_url()?>welcome/prensa"><?=label('prensa');?></a></li>
                            <li><a href="<?=base_url()?>welcome/terminos"><?=label('terminosCondiciones');?></a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-6 mb-xs-24">
                        ...
                        <ul>
                            <li><a href="<?=base_url()?>welcome/index/#planes"><?=label('cuantoDeboPagar');?></a></li>
                            <li><a href="<?=base_url()?>welcome/index/#planes"><?=label('tiposDePlanes');?></a></li>
                            <li><a href="<?=base_url()?>welcome/index/#planes"><?=label('metodosDePago');?></a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-6 mb-xs-24">
                    ...
                    <div class="col-md-3 col-sm-6 mb-xs-24">
                        ...
                        <h6 class="uppercase"><a href="<?=base_url()?>welcome/index/#contacto"><?=label('contactenos');?></a></h6>
                        <ul>
