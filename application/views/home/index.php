            ...
            <div class="container v-align-transform">
                <div class="row">
                    <div class="col-md-6 col-sm-8 texto-slider">
                        ...
                        <p class="lead mb40"></p>
                        <a class="btn btn-lg boton-claro" href="<?= base_url() ?>inicio"
                           style="border: 2px solid white"><?= label('pruebeloGratis'); ?></a>
                    </div>
                </div>
...
<section id="contacto">
    <div class="container">
        <div class="row">
            <div class="col-xs-8 col-sm-4 col-md-5 col-xs-offset-2 col-sm-offset-1 col-md-offset-1"
                ...
                <p></p>
                <hr>
                <p><strong>C:</strong><?= label('correoInicio'); ?>&nbsp; &nbsp;
                    &nbsp;<br><strong>T:</strong><?= label('telefonoInicio'); ?>&nbsp; &nbsp; &nbsp;<br>
                </p>
            </div>
            <div class="col-xs-10 col-sm-6 col-md-5 col-xs-offset-1 col-sm-offset-1 col-md-offset-1"
                 style="margin-top: 3%;">
