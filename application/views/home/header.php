...
<div class="nav-container"><nav>
        <div class="nav-utility">
            ...
            <div class="module right">
                <a class="btn btn-sm" href="<?=base_url()?>welcome/faq">FAQ</a><a class="btn btn-sm" href="<?=base_url()?>inicio">REGISTRARSE</a><a class="btn btn-sm" href="<?=base_url()?>inicio">Ingresar</a>
            </div>
        </div>
        <div class="nav-bar">
            <div class="module left">
