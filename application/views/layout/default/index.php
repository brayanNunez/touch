...
<head>
    ...
    <link href="<?= base_url() ?>assets/dashboard/js/plugins/material-preloader/materialPreloader.css" type="text/css"
...
<div id="main">
        ...
        <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold"><a href="index.html" class="waves-effect waves-cyan"><i
                            class="mdi-action-dashboard"></i> Inicio</a>
                </li>
                <li class="bold"><a href="#" class="waves-effect waves-cyan"><i class="mdi-communication-email"></i>
                        Cotizaciones <span class="new badge">4</span></a>
                </li>
                <li class="bold"><a href="#" class="waves-effect waves-cyan"><i class="mdi-action-favorite"></i>
                        Servicios</a>
                </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i
                                    class="mdi-action-invert-colors"></i> Productos</a>
    ...
    <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-image-palette"></i>
    ...
    <li class="bold"><a href="#" class="waves-effect waves-cyan"><i class="mdi-device-now-widgets"></i> Avanzado <span
                                ...
                                <div class="move-up cyan darken-1">
                                    <div>
                                        ...
                                        <div class="chart-revenue cyan darken-2 white-text">
                                            ...
                                            <p class="chart-revenue-per"><i class="mdi-navigation-arrow-drop-up"></i>
                                                21.80 %</p>
                                        </div>
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        <img class="activator"
                                             src="<?= base_url() ?>assets/dashboard/images/user-bg.jpg"
                                             alt="user background">
                                    </div>
                                    <div class="card-content">
                                    ...
                                    <div class="card-reveal">
                                        ...
                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> Agregar
                                            Contactos</p>
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    ...
                                    <div class="card-reveal">
                                        ...
                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> Llévate tu
                                            embed ...</p>
                            ...
                            <div class="col s12 m6 l4">
                                <div id="profile-card" class="card">
                                    ...
                                    <div class="card-reveal">
                                        ...
                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> Reporte x
                                        </p>

                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> Reporte y
                                        </p>

                                        <p><i class="mdi-action-perm-identity cyan-text text-darken-2"></i> Todos los
                                            reportes</p>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body favorite-associates">
                            <div class="favorite-associate-list chat-out-list row">
                                <div class="col s4"><img src="<?= base_url() ?>assets/dashboard/images/avatar.jpg"
                                                         alt=""
