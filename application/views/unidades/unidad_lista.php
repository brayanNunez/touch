                                        ...
                                        <div class="row">
                                            <div class="col s12 m12 l12">
                                                <div class="agregar_nuevo">
                                                    <a href="#Agregar"
                                                       class="btn btn-default modal-trigger"><?= label('unidadNueva'); ?></a>
                                                </div>
                                                <table id="unidades-tabla-lista"
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            <input type="checkbox" class="filled-in checkbox"
                                                                   id="checkbox_unidad1"/>
                                                            <label for="checkbox_unidad1"></label>
                                                        </td>
                                                        <td>Kilogramos</td>
                                                        <td>
                                                            <ul id="dropdown-unidad1" class="dropdown-content">
                                                                <li>
                                                            ...
                                                            <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                               href="#!" data-activates="dropdown-unidad1">
...
<script>
    ...
    $(document).ready( function () {
        $('#unidades-tabla-lista').dataTable( {
            'aoColumnDefs': [{
                'bSortable': false,
                'aTargets': [0, -1] /* 1st one, start by the right */
            }]
        });
        $('table#unidades-tabla-lista thead th:first').removeClass('sorting_asc').addClass('sorting_disabled');
        $('table#unidades-tabla-lista thead th:nth-child(2)').removeClass('sorting').addClass('sorting_asc');
    });
    $(document).ready(function () {
        $('#checkbox-all').click(function (event) {
            var $this = $(this);
            var tableBody = $('#unidades-tabla-lista').find('tbody tr[role=row] input[type=checkbox]');
...
<div id="eliminarElementosSeleccionados" class="modal">
    ...
    <div class="modal-footer black-text">
        <div id="botonElimnar" title="unidades-tabla-lista">
            <a href="#"
