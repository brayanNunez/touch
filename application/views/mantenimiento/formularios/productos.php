        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h1 class="breadcrumbs-title"><?=label('tituloFormularioProducto');?></h1>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <form class="col s12">
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="producto_codigo" type="text">
                                            <label for="producto_codigo"><?=label('formProducto_codigo');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="producto_nombre" type="text">
                                            <label for="producto_nombre"><?=label('formProducto_nombre');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <textarea id="producto_descripcion" class="materialize-textarea" length="120"></textarea>
                                            <label for="producto_descripcion"><?=label('formProducto_descripcion');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="producto_precio" type="text">
                                        ...
                                        <div class="input-field col s12 envio-formulario">
                                            <button class="btn waves-effect waves-light right" type="submit" name="action"><?=label('formProducto_enviar');?>
                                            </button>
                                        </div>
                                    </div>
                                </form>
