                                    ...
                                    <div class="row">
                                        ...
                                        <div id="embedCategoria">
                                            ...
                                            <div id="table">
                                                ...
                                                <table id="example" class="table table-responsive striped"
                                                       data-search="true">
                                                    <thead>
                                                    <tr>
                                                    ...
                                                    <tr data-tt-id="2" data-tt-parent-id="1">
                                                        <td><span style="margin-left: 20px">
                                                            <input type="checkbox" class="filled-in" id="idAlimentos"
                                                                   checked="checked">
                                                    ...
                                                    <tr data-tt-id="4" data-tt-parent-id="1">
                                                        <td><span style="margin-left: 20px">
                                                            <input type="checkbox" class="filled-in" id="idBebidas"
                                                                   checked="checked">
                                                    ...
                                                    <tr data-tt-id="5" data-tt-parent-id="4">
                                                        <td><span style="margin-left: 20px">
                                                             <input type="checkbox" class="filled-in" id="idGaseosas"
                                                                    checked="checked">
                                                    ...
                                                    <tr data-tt-id="6" data-tt-parent-id="5">
                                                        <td><a href="<?= base_url() ?>productos/editar">Coca Cola</a>
                                                        </td>
                                                    ...
                                                    <tr data-tt-id="8" data-tt-parent-id="4">
                                                        <td><span style="margin-left: 20px">
                                                            <input type="checkbox" class="filled-in" id="idNaturales"
                                                                   checked="checked">
                                        ...
                                        <div class="col-sm-12 bloque-embed-cliente">
                                            ...
                                            <div class="input-field col s12">
                                                <input type="checkbox" class="filled-in" id="campoMostrar1"
                                                       checked="checked">
                                                <label for="campoMostrar1">Nombre</label>
                                            </div>
                                            <div class="input-field col s12">
                                                <input type="checkbox" class="filled-in" id="campoMostrar2"
                                                       checked="checked">
                                                <label for="campoMostrar2">Teléfono</label>
                                            </div>
                                            <div class="input-field col s12">
                                                <input type="checkbox" class="filled-in" id="campoMostrar3"
                                                       checked="checked">
                                                <label for="campoMostrar3">Correo</label>
                                            </div>
                                            <div class="input-field col s12">
                                                <input type="checkbox" class="filled-in" id="campoMostrar4"
                                                       checked="checked">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            ...
                                            <textarea class="bloque-embed-codigo-generado" readonly
                                                      style="height:80px;"><a class="embedly-card"
                                                                              href="http://mrrabbit.cr/clientes/touch/inicio">Touch!</a><script
                                        ...
                                        <div class="input-field col s12 envio-formulario">
                                            <a href="<?= base_url() ?>embed/embedCotizar"
                                               class="btn waves-effect waves-light right"><?= label('copiarCodigo'); ?>
                                            </a>
                                        </div>
