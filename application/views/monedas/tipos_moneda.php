...
<script>
    ...
    var idEliminar = 0;
       ...
       $(document).on('click','.confirmarEliminar', function () {
        ...
        $('#eliminarMoneda #botonEliminar').on('click', function () {
           event.preventDefault();
           $.ajax({
                  data: {idEliminar : idEliminar},
                  url:   '<?=base_url()?>monedas/eliminar',
                  type:  'post',
                  // beforeSend: function () {
...
<!-- lista modals -->
<div id="eliminarMoneda" class="modal">
...
<div id="eliminarElementosSeleccionados" class="modal">
    ...
    <div class="modal-footer black-text">
        <div id="botonEliminar" title="monedas-tabla-lista">
            <a href="#"
