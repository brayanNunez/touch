                    ...
                    <div id="submit-button" class="section">
                        <div class="row">
                            <div class="col s12 m12 l8">
                                <form class="col s12" action="<?=base_url()?>empleados/modificar/<?php if(isset($resultado)){echo $resultado->idEmpleado;}?>" method="POST">
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="empleado_codigo" name="empleado_codigo" type="text" value= '<?php if(isset($resultado)){echo $resultado->codigo;}?>'>
                                            <label for="empleado_codigo"><?=label('formEmpleado_codigo');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="empleado_id" name="empleado_id" type="text" value= '<?php if(isset($resultado)){echo $resultado->identificacion;}?>'>
                                            <label for="empleado_id"><?=label('formEmpleado_identificacion');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="empleado_nombre" name="empleado_nombre" type="text" value= '<?php if(isset($resultado)){echo $resultado->nombreCompleto;}?>'>
...
<!--                                         </div> -->
                                        ...
                                        <div class="input-field col s12">
                                            <input id="empleado_fechaNacimiento" name="empleado_fechaNacimiento" type="date" value= '<?php if(isset($resultado)){echo $resultado->fechaNacimiento;}?>'>
                                            <label for="empleado_fechaNacimiento"><?=label('formEmpleado_fechaNacimiento');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <input id="empleado_fechaIngreso" name="empleado_fechaIngreso" type="date" value= '<?php if(isset($resultado)){echo $resultado->fechaIngresoEmpresa;}?>'>
                                            <label for="empleado_fechaIngreso"><?=label('formEmpleado_fechaIngreso');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                            <textarea id="empleado_descripcion" name="empleado_descripcion" class="materialize-textarea" length="120"><?php if(isset($resultado)){echo $resultado->descripcion;}?></textarea>
