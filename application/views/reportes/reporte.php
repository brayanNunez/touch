                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s12 m12 l12">
                                                <table id="data-table-simple" class="responsive-table display"
                                                       cellspacing="0">
                                                    <div align="right">
                                                        <a class="dropdown-button btn-floating  waves-effect waves-light "
                                                           href="#!" data-toggle="tooltip"
                                                           title="<?= label('Descargar reporte') ?>"
                                                    ...
                                                    <!--                                       <tr>-->
                                                    <!--                                          <th>-->
                                                    <? //=label('tablaCotizaciones_codigo');?><!--</th>-->
                                                    <!--                                          <th>-->
                                                    <? //=label('tablaCotizaciones_fecha');?><!--</th>-->
                                                    <!--                                          <th>-->
                                                    <? //=label('tablaCotizaciones_cliente');?><!--</th>-->
                                                    <!--                                          <th>-->
                                                    <? //=label('tablaCotizaciones_monto');?><!--</th>-->
                                                    <!--                                          <th>-->
                                                    <? //=label('tablaCotizaciones_estado');?><!--</th>-->
                                                    <!--                                          <th>-->
                                                    <? //=label('tablaCotizaciones_opciones');?><!--</th>-->
                                                    <!--                                       </tr>-->
                                                    </tfoot>
                                                    <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn_duplicar modal-trigger icono-edicion"
                                                               href="#duplicar" data-toggle="tooltip"
                                                               title="<?= label('tooltip_duplicar') ?>">
                                                            ...
                                                            <a class="btn_eliminar modal-trigger icono-edicion"
                                                               href="#Elminar" data-toggle="tooltip"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Enviada</td>
                                                        <td>
                                                            <a class="btn_duplicar modal-trigger icono-edicion" href="#"
                                                               data-toggle="tooltip"
                                                               title="<?= label('tooltip_duplicar') ?>">
                                                                <i class="mdi-content-content-copy"></i>
                                                            </a>
                                                            ...
                                                            <a class="btn_finalizar modal-trigger icono-edicion"
                                                               href="#" data-toggle="tooltip"
                                                               title="<?= label('tooltip_finalizar') ?>">
                                                                <i class="mdi-action-done"></i>
                                                            </a>
                                                            <a class="btn_eliminar modal-trigger icono-edicion" href="#"
                                                               data-toggle="tooltip"
                                                               title="<?= label('tooltip_eliminar') ?>">
                                                                <i class="mdi-action-delete"></i>
                                                            </a>
