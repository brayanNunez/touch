      ...
      <div class="container">
         <div class="row">
            <div class="col s12 m12 l12">
               <h1 class="breadcrumbs-title"><?=label('tituloListaSolicitidesSinCliente');?></h1>
            </div>
         </div>
      </div>
   </div>
                                    ...
                                    <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td>
                                                <a class="modal-trigger icono-edicion" href="<?=base_url()?>solicitud/revisar_solicitud" data-toggle="tooltip" title="<?=label('tooltip_verEditar')?>">
                                                   <i class="mdi-editor-mode-edit"></i>
                                                </a>
                                                            <!--                                                            <a class="modal-trigger" href="#eliminarContacto">--><?//=label('eliminar');?><!--</a>-->
                                                <a class="modal-trigger icono-edicion" href="#eliminarSolicitud" data-toggle="tooltip" title="<?=label('tooltip_eliminar')?>">
