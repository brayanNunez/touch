                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s12 m12 l12">
                                                <table id="data-table-simple" class="responsive-table display"
                                                    ...
                                                    <!--                                          <tr>-->
                                                    <!--                                             <th>-->
                                                    <? //=label('tablaPorAbrobar_cliente');?><!--</th>-->
                                                    <!--                                             <th>-->
                                                    <? //=label('tablaPorAbrobar_monto');?><!--</th>-->
                                                    <!--                                             <th>-->
                                                    <? //=label('tablaPorAbrobar_fecha');?><!--</th>-->
                                                    <!--                                             <th>-->
                                                    <? //=label('tablaPorAbrobar_opciones');?><!--</th>-->
                                                    <!--                                          </tr>-->
                                                    </tfoot>
                                                    <tbody>
                                                    <tr>
                                                        ...
                                                        <td>4/3/2015</td>
                                                        <td>
                                                            <a class="icono-edicion"
                                                               href="<?= base_url() ?>Solicitud/ver"
                                                               data-toggle="tooltip"
                                                               title="<?= label('tooltip_revisar') ?>">
