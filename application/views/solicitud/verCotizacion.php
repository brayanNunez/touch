                            ...
                            <div class="col s12 ">
                                <div class="card" id="lista-elementos">
                                        ...
                                        <div class="listaHojas">
                                            <div class="hoja">
                                                ...
                                                <div id="encabezado">
                                                    <div id="logo">
                                                        <img class="imagen"
                                                             src="<?= base_url() ?>assets/dashboard/images/sombrero.png">
                                                        </img>
                                                    </div>
                                                    ...
                                                    <div id="datallesCotizacion">
                                                        <table style="width:100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>20</td>
                                                                <td><img
                                                                        src="<?= base_url() ?>assets/dashboard/images/almuerzo.jpg">
                                                                </td>
                                                                <td>$120</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <td></td>
                                                            <td><img
                                                                    src="<?= base_url() ?>assets/dashboard/images/musica.jpg">
                                                            </td>
                                                            <td>$30</td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <div id="informacion">
                                                    <div class="datos">
                                                        ...
                                                        <p>Detalle: Por las especificaciones del equipo, es posible que
                                                            existan variantes entre impresiones sin que esto represente
                                                            para nosotros problemas de calidad. La presente oferta tiene
                                                            una validéz de 15 días naturales a partir de esta
                                                            fecha. </p>

                                                        <p>Nota: El cliente se hace responsable por el cumplimiento de
                                                            las legislaciones vigentes en materia de contenido y
                                                            producto de las etiquetas solicitadas, y exime a Mr Rabbit
                                                            de cualquier responsabilidad en ese sentido.</p>
                                                        <br>
                                                ...
                                                <div id="footerCotizacion">
                                                    ...
                                                    <div id="datosFooter">
                                                        ...
                                                        <div class="datos" id="datos2">
                                                            <p>Con el mayor deseo de servirle, me pongo a su entera
                                                                disposición.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="informacionSistema">
                                                    <p>Esta cotización ha sido desarrollada en la plataforma:
                                                        touchcr.com</p>
                                                </div>
                                            </div>
                                            <div style="margin-bottom: 10px;" class="row" id="zonaDescarga">
                                                <a class="dropdown-button btn-floating right waves-effect waves-light "
                                    ...
                                    <div class="input-field col s12 envio-formulario">
                                        <a href="#enviar" class="modal-trigger">
                                            <button class="btn waves-effect waves-light right" type="submit"
                                                    name="action"><?= label('aprobarEnvioCliente'); ?>
                                            </button>
                                        </a>
                                        <br>
...
<div id="enviar" class="modal">
    ...
    <div class="modal-footer">
        <a href="<?= base_url() ?>Solicitud/porAbrobar"
