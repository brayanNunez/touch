                    ...
                    <div id="submit-button" class="section">
                        <div class="row">
                            <div class="col s12 m12 l8">
                                <form class="col s12" action="<?=base_url()?>clientes/agregar">
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12">
                                            ...
                                            <label for="solicitud_telefono"><?=label('formSolicitud_telefono');?></label>
                                        </div>
                                        <div class="input-field col s12">
                                        ...
                                        <div class="input-field col s12">
                                            <textarea id="solicitud_datosAdicionales" class="materialize-textarea" length="120" readonly></textarea>
                                            <label for="solicitud_datosAdicionales"><?=label('formSolicitud_datosAdicionales');?></label>
                                        </div>
                                        <div class="input-field col s12 envio-formulario">
                                            <button class="btn waves-effect waves-light right" type="submit" name="action"><?=label('formSolicitud_agregarCliente');?>
                                            </button>
                                            <br>
