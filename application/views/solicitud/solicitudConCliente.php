                            ...
                            <div class="col s12 m12 l12">
                                <div class="card lista-elementos">
                                    <div id="table-datatables">
                                        <div class="row">
                                            <div class="col s12 m12 l12">
                                                <table id="solicitudesConCliente-tabla-lista" class="data-table-information responsive-table display"
                                                       cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;">
                                                                <input type="checkbox" class="filled-in checkbox"
                                                                       id="checkbox_solicitudConCliente1"/>
                                                                <label for="checkbox_solicitudConCliente1"></label>
                                                            </td>
                                                            <td>Mario Mendez</td>
                                                            ...
                                                            <td>
                                                                <ul id="dropdown-solicitudConCliente1" class="dropdown-content">
                                                                    <li>
                                                                        <a href="<?= base_url() ?>solicitud/ver_solicitud"
                                                                ...
                                                                <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                                   href="#!" data-activates="dropdown-solicitudConCliente1">
...
<script>
    ...
    $(document).ready(function () {
        $('#solicitudesConCliente-tabla-lista').dataTable( {
            'aoColumnDefs': [{
                'bSortable': false,
                'aTargets': [0, -1] /* 1st one, start by the right */
            }]
        });
        $('table#solicitudesConCliente-tabla-lista thead th:first').removeClass('sorting_asc').addClass('sorting_disabled');
        $('table#solicitudesConCliente-tabla-lista thead th:nth-child(2)').removeClass('sorting').addClass('sorting_asc');
    });
    $(document).ready(function () {
        $('#checkbox-all').click(function (event) {
            var $this = $(this);
            var tableBody = $('#solicitudesConCliente-tabla-lista').find('tbody tr[role=row] input[type=checkbox]');
...
<div id="eliminarElementosSeleccionados" class="modal">
    ...
    <div class="modal-footer black-text">
        <div id="botonElimnar" title="solicitudesConCliente-tabla-lista">
            <a href="#"
