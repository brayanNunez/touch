                                        ...
                                        <div class="row">
                                            <div class="col s12 m12 l12">
                                                <table id="data-table-simple" class="responsive-table display"
                                                    ...
                                                    <!--                                                    <tr>-->
                                                    <!--                                                        <th>-->
                                                    <? //=label('tablaPagos_empresa');?><!--</th>-->
                                                    <!--                                                        <th>-->
                                                    <? //=label('tablaPagos_fecha');?><!--</th>-->
                                                    <!--                                                        <th>-->
                                                    <? //=label('tablaPagos_pago');?><!--</th>-->
                                                    <!--                                                        <th>-->
                                                    <? //=label('tablaPagos_opciones');?><!--</th>-->
                                                    <!--                                                    </tr>-->
                                                    </tfoot>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>$30</td>
                                                        <td>
                                                            <a class="btn_verComprobante modal-trigger"
                                                               href="#verComprobante"><?= label('ver_comprobante'); ?></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
