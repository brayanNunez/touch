    ...
    <form id="formPersona" action="<?= base_url(); ?>proveedores/modificar/<?= $idEncriptado; ?>" method="POST" class="col s12">
        <div class="row">
            ...
            <div>
                ...
                <div class="input-field col s12">
                    <textarea length="200" maxlength="200" id="persona_descripcion" name="persona_descripcion" class="materialize-textarea"
            ...
            <div class="col s12 proveedor-editar-tabs-secundarios">
                <div id="tab-direccion-editar" class="card col s12">
                    ...
                    <div class="input-field col s12 m12 l12">
                        <textarea length="200" maxlength="200" id="persona_direccionDomicilio" name="persona_direccionDomicilio" class="materialize-textarea" rows="4"><?= $domicilio; ?></textarea>
                            ...
                            if($gastos != false) {
                                ...
                                foreach ($gastos as $gasto) {
                                    ...
                                    <tr id="gasto<?= $contador; ?>">
                                        ...
                                        <td>
                                            <span id="span_gasto<?= $contador; ?>_monto"><span class="moneda_signo"></span><?= $gasto['monto']; ?></span>
...
//            principal,
        ...
        arrayGastosExistentes.push({"posicion": arrayGastosExistentes.length, "id": 0,"codigo": codigo});
        contadorGasto++;
...
//        $('#editarGasto #gasto_formaPago').val(formaPago);
    ...
    $(document).on('click', '#editarGasto #btnEditarGasto', function () {
        ...
        for(var j = 0; j < arrayNombres.length; j++) {
            if(arrayNombres[j]['codigo'] == codigo.val()) {
                if(arrayGastosExistentes[idEditar]['codigo'] != codigo.val()) {
                    existeCodigo = true;
                    break;
                }
            }
...
//                                alert(nombreTipo + '  -  ' + codigo.val() + '  -  ' + nombre.val() + '  -  ' + nombreCategoria + '  -  ' + nombreFormaPago + '  -  ' + monto.val());
                                ...
                                for (var j = 0; j < arrayNombres.length; j++) {
                                    if (arrayNombres[j]['idGasto'] == idGE) {
                                        arrayNombres[j]['codigo'] = codigo.val();
                                    }
                                }
...
<!--Script para manejo de tabla de gastos y eliminar gastos-->
<script>
    $(document).on("ready", function () {
        <?php
            if (isset($lista)) {
...
<div id="transaccionCorrecta" class="modal">
    ...
    <div class="modal-content">
        <p><?= label('personaEditadoCorrectamente'); ?></p>
    </div>
