                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <select>
                                                ...
                                                <option value="2"
                                                        selected><?= label('formProveedor_juridico'); ?></option>
                                            </select>
                                            <label
                                                for="proveedor_tipo"><?= label('formProveedor_tipoProveedor'); ?></label>
                                        </div>
                                        <div class="input-field col s12">
                                        ...
                                        <div class="input-field col s12">
                                            ...
                                            <label
                                                for="proveedor_id"><?= label('formProveedor_identificacion'); ?></label>
                                        </div>
                                        <div class="input-field col s12">
                                        ...
                                        <!--                                        <div class="input-field col s12">-->
                                        <!--                                            <label for="proveedor_palabras">-->
                                        <? //=label('formProveedor_palabrasClave');?><!--</label>-->
                                        <!--                                            <input id="proveedor_palabras" type="text" value="Diseño">-->
                                        <!--                                            <div class="input-field col s12">-->
                                        <!--                                                <div class="input-field col s8">-->
                                        <!--                                                    <input id="otra_palabra" type="text">-->
                                        <!--                                                    <label for="otra_palabra">-->
                                        <? //=label('formProveedor_nuevaPalabra');?><!--</label>-->
                                        <!--                                                </div>-->
                                        <!--                                                <div class="input-field col s4">-->
                                        <!--                                                    <a href="#" class="btn btn-default">-->
                                        <? //=label('formProveedor_agregar');?><!--</a>-->
                                        <!--                                                </div>-->
                                        <!--                                            </div>-->
                                        <!--                                            <hr />-->
                                        <!--                                        </div>-->
                                        ...
                                        <div class="inputTag col s12">
                                            <label
                                                for="empleado_palabras"><?= label('formProveedor_palabrasClave'); ?></label>
                                            <input placeholder="<?= label('formProveedor_anadirPalabraClave'); ?>"
                                                   id="empleado_palabras" type="text" value="Palabra1, Palabra2"
                                                   data-role="tagsinput"/>
                                        </div>

                                        <div class="input-field col s12">
                                            <textarea id="proveedor_descripcion" class="materialize-textarea"
                                                      length="120">Diseñador profesional</textarea>
                                            <label
                                                for="proveedor_descripcion"><?= label('formProveedor_descripcion'); ?></label>
                                        </div>
                                        ...
                                        <div class="input-field col s12 envio-formulario">
                                            <button class="btn waves-effect waves-light right" type="submit"
                                                    name="action"><?= label('formProveedor_editar'); ?>
                                            </button>
                                        </div>
                                    </div>
                                </form>
