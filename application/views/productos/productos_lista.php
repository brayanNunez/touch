                                        ...
                                        <table id="productos-tabla-lista" class="table display striped" cellspacing="0"
                                            ...
                                            <tr data-tt-id="3" data-tt-parent-id="2">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto3">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <tr data-tt-id="4" data-tt-parent-id="1">
                                                ...
                                                <td>
                                                    <ul id="dropdown-producto4" class="dropdown-content">
                                                        <li>
                                                            <a href="#agregarCategoría"
                                                               class="-text modal-trigger"><?= label('menuOpciones_agregarProducto') ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="#editarCategoría"
                                                               class="-text modal-trigger"><?= label('menuOpciones_editar') ?></a>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto4">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <tr data-tt-id="5" data-tt-parent-id="4">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto5">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <tr data-tt-id="6" data-tt-parent-id="5">
                                                <td style="text-align: center;">
                                                    <input type="checkbox" class="filled-in checkbox"
                                                           id="checkbox_producto6"/>
                                                    <label for="checkbox_producto6"></label>
                                                </td>
                                                <td>
                                                    <span class="nivel4"><a href="<?= base_url() ?>productos/editar">Coca
                                                            Cola</a></span>
                                                </td>
                                                <td>00006</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto6">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <tr data-tt-id="7" data-tt-parent-id="5">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto7">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <tr data-tt-id="8" data-tt-parent-id="4">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto8">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <tr data-tt-id="9" data-tt-parent-id="8">
                                                <td style="text-align: center;">
                                                    <input type="checkbox" class="filled-in checkbox"
                                                           id="checkbox_producto9"/>
                                                    <label for="checkbox_producto9"></label>
                                                </td>
                                                <td>
                                                    <span class="nivel4"><a href="<?= base_url() ?>productos/editar">Te
                                                            frio</a></span>
                                                </td>
                                                <td>00008</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto9">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
                                            ...
                                            <tr data-tt-id="10" data-tt-parent-id="8">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="boton-opciones btn-flat dropdown-button waves-effect white-text"
                                                       href="#!" data-activates="dropdown-producto10">
                                                        <?= label('menuOpciones_seleccionar') ?><i
                                                            class="mdi-navigation-arrow-drop-down"></i>
                                                    </a>
                                                </td>
