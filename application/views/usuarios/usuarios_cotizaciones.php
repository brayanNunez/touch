...
<script>
    ...
    $(document).on('ready', function(){
        ...
        $('#opciones-seleccionados-print').on("click", function(){
            tablaHtml = htmlTabla('usuario_cotizaciones', true);
            Popup(tablaHtml);
        });
        ...
        $('#opciones-seleccionados-Excel').on("click", function(){
            var html = htmlTabla('usuario_cotizaciones', false);
        ...
        $('#opciones-seleccionados-PDF').on("click", function(){
            ...
            body += htmlTabla('usuario_cotizaciones', false);
...
<div id="eliminarElementosSeleccionados" class="modal">
    ...
    <div class="modal-footer black-text">
        <div id="botonEliminar" class="modal-footer black-text" title="usuario_cotizaciones">
            <a href="#"
               class="deleteall waves-effect waves-red btn-flat modal-action modal-close"><?= label('aceptar'); ?></a>
        </div>
    </div>
