    ...
    public function modificar() {
        ...
        if($tipo == 1) {
            $data['datos'] = array(
                ...
                'fechaCreacion' => date("Y-m-d", strtotime($this->input->post('empresa_trabajadorFechaNacimiento'))),
...
//                'telefonoMovil' => $this->input->post('empresa_trabajadorTelefonoMovil'),
            ...
            $data['datos'] = array(
                ...
                'fechaCreacion' => date("Y-m-d", strtotime($this->input->post('empresa_fechaCreacion'))),
    ...
    public function completar() {
        ...
        if($tipo == 1) {
            $data['datos'] = array(
                ...
                'fechaCreacion' => date("Y-m-d", strtotime($this->input->post('registro_fechaNacIndependiente'))),
                ...
                'nombreRepresentante' => $this->input->post('registro_nombreRepresentante'),
                'primerApellidoRepresentante' => $this->input->post('registro_primerApellidoRepresentante'),
                'segundoApellidoRepresentante' => $this->input->post('registro_segundoApellidoRepresentante')
            );
            $data['usuario'] = array(
            ...
            $data['datos'] = array(
                ...
                'telefono' => $this->input->post('registro_telefonoFijo'),
                'telefonoMovil' => $this->input->post('registro_telefonoMovil'),
                'fechaCreacion' => date("Y-m-d", strtotime($this->input->post('registro_fechaCreacionEmpresa'))),
                'tamano' => $this->input->post('registro_tamanoEmpresa'),
                'codigoCotizacion' => $this->input->post('registro_codigoCotizacion'),
                'nombreRepresentante' => $this->input->post('registro_nombreRepresentante'),
                'primerApellidoRepresentante' => $this->input->post('registro_primerApellidoRepresentante'),
