        ...
        // $("button[type= 'submit']").on("click", function(){
            ...
            $('#form_impuestoEditar').validate({
             ...
             var reglasCliente = {
                ...
                cliente_correo: {required: false, maxlength: 45},
                ...
                clientejuridico_nombreFantasia: {required: false, maxlength: 45},
                clientejuridico_correo: {required: false, maxlength: 45},
                clientejuridico_telefono: {required: false, maxlength: 45},
                clientejuridico_fax: {required: false, maxlength: 45},

                 // cliente_direccionPais: {required: true, maxlength: 45},
                 cliente_direccionProvincia: {required: false, maxlength: 45},
                 cliente_direccionCanton: {required: false, maxlength: 45},
                 cliente_direccionDomicilio: {required: false, maxlength: 200},

                cliente_descuento: {required: false, maxlength: 45}
             };
            ...
            var reglasPersona = {
                ...
                persona_correo: { required: false, maxlength: 45},
                ...
                personajuridico_correo: { required: false, maxlength: 45},
                personajuridico_telefono: { required: false, maxlength: 45},
                personajuridico_fax: { required: false, maxlength: 45},
                persona_palabras: { required: false, maxlength: 45},
                persona_descripcion: { required: false, maxlength: 200},
                 persona_direccionPais: { required: false, maxlength: 45},
                 persona_direccionProvincia: { required: false, maxlength: 45},
                 persona_direccionCanton: { required: false, maxlength: 45},
